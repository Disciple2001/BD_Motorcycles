...
onMounted(() => {
  try {
    const promesa = window.electronAPI.get_resumenMarcasModelos()
  ...
  <div class="scrollable-table">
    <table class="table bg-gray-900">
      ...
      <tr class="">
        ...
        <th>Ingresos por tarjeta</th>
        <th>Ingresos por cheque</th>
        <th>Ingresos por efectivo</th>
      </tr>
      </thead>
      <tbody>
      <tr v-for="item in data">
        ...
        <td class="">
          {{ item.ing_tot? item.ing_tot : "No alquilado" }}
        </td>
        <td class="">
          {{ item.ing_tar }}
        </td>
